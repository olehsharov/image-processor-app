<template>
    <div class="absolute inset-0" :style="coverStyles" ref="cover" @mousemove="e => move(e)" id="cover" @mousedown="e => saveOrigin(e)">
        <div :style="boxStyles" class="z-10 border absolute" ref="box" id="box" @mousedown="e => moveStart(e, 'box')">
            <div class="w-2 h-2 -ml-1 -mt-1 left-0 top-0 bg-gray-900 absolute border border-gray-1000" :style="handleStyles" @mousedown="e => moveStart(e,'tl')" id="tl"></div>
            <div class="w-2 h-2 -mr-1 -mt-1 right-0 top-0 bg-gray-900 absolute border border-gray-1000" :style="handleStyles" @mousedown="e => moveStart(e, 'tr')" id="tr"></div>
            <div class="w-2 h-2 -mr-1 -mb-1 right-0 bottom-0 bg-gray-900 absolute border border-gray-1000" :style="handleStyles" @mousedown="e => moveStart(e, 'br')" id="br"></div>
            <div class="w-2 h-2 -ml-1 -mb-1 left-0 bottom-0 bg-gray-900 absolute border border-gray-1000" :style="handleStyles" @mousedown="e => moveStart(e, 'bl')" id="bl"></div>
        </div>
    </div>
</template>
